...
QT_MOC_LITERAL(3, 22, 6), // "buffer"
QT_MOC_LITERAL(4, 29, 5) // "ready"

    },
    "SerialPort\0readyRead\0\0buffer\0ready"
};
...
void SerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialPort::readyRead)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void SerialPort::readyRead(QByteArray _t1)
{
