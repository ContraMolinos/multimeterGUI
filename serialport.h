...
/*! \class SerialPort
 * \brief Class to manage the communication with a serial port.
 *
 * RS 22-812 sends 9bytes long packets with the codified information. This class is meant to read those packets and send it to the RS22812 class to store and interpret.
 */
